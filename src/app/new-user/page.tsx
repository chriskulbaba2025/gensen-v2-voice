 ...
 useEffect(() => {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 text-center bg-gray-50 transition-all duration-700 relative overflow-hidden">
      ...
      {/* COMPLETE STAGE */}
<div
  className={`flex flex-col items-center justify-start text-center px-[40px] pt-[20px] pb-[40px] transition-opacity duration-[1500ms] ease-in-out ${
    stage === "complete"
      ? "opacity-100"
      : "opacity-0 pointer-events-none"
  }`}
>
  ...
  {htmlContent && (
    <div
      className="report-container bg-white border border-[#e0e6f5] rounded-[12px] shadow-soft p-[24px] mb-[40px] max-w-[760px] text-left opacity-0 animate-[fadeIn_1.2s_ease_forwards]"
