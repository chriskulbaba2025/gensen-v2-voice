...
export default function Step2() {
  ...
  const handleNext = (e: React.FormEvent) => {
    e.preventDefault();
    if (!message.trim()) {
      alert('Please enter your brand message.');
      return;
    }
    setData({ message });
    ...
    <main className="min-h-screen flex flex-col px-4 pt-12">
      ...
      >
        <h1 className="text-2xl font-bold mb-6 text-center">
          Step 2: Refine Your Brand Message
        </h1>
        ...
        <label className="block mb-6">
          ...
          <textarea
            ...
            placeholder="Write a compelling, descriptive brand message here. Ex: 'We help busy moms simplify healthy eating with fun, fast recipes.'"
