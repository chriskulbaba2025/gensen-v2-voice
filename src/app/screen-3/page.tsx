...
export default function Step3() {
  ...
  const handleNext = (e: React.FormEvent) => {
    ...
    // Save only valid FormData fields
    setData({
      topic: contentFocus,
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-4 pt-12 mb-20">
      ...
      <p className="text-gray-600 text-center max-w-2xl mb-10 leading-relaxed">
        Your voice is now mapped for tone and clarity.
        This step helps GENSEN read how you naturally write,
        so it can refine your Brand Voice Framework with precision.
      </p>
      ...
      <section className="bg-gray-50 border rounded-lg p-6 shadow-sm w-full max-w-3xl mb-8">
        ...
        <p className="text-sm text-gray-600 mb-3">
          What core idea, goal, or direction should your brand emphasize?
        </p>
        <textarea
          rows={2}
          value={contentFocus}
          onChange={(e) => setContentFocus(e.target.value)}
          placeholder="E.g. Helping teams grow through clarity and direction."
      ...
      <section className="bg-gray-50 border rounded-lg p-6 shadow-sm w-full max-w-3xl mb-10">
        ...
        <p className="text-sm text-gray-600 mb-3">
          Add a short email, post, or paragraph that captures your natural writing style.
        </p>
        <textarea
          rows={6}
          value={writingSample}
